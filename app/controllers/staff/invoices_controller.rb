...
module Staff
  class InvoicesController < Staff::BaseController
    ...
    def create
      ...
      if @invoice.save
        redirect_to staff_invoice_path(@invoice), notice: "Factura creada correctamente."
      else
    ...
    def mark_sent
      ...
      redirect_to staff_invoice_path(@invoice), notice: "Factura marcada como enviada."
    end
    ...
    def download_pdf
      ...
      send_data pdf.render, filename: "factura_#{@invoice.invoice_number}.pdf", type: "application/pdf", disposition: "inline"
    end
